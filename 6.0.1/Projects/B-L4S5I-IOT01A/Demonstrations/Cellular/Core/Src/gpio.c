...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, MDM_SIM_SELECT_1_Pin|MDM_SIM_SELECT_0_Pin|MDM_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MDM_DTR_Pin|LED2_Pin|MDM_PWR_EN_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = MDM_SIM_SELECT_1_Pin|MDM_SIM_SELECT_0_Pin|MDM_RST_Pin;
